...
BIF_RETTYPE decode_packet_3(BIF_ALIST_3)
{
    ...
    case am_sip: type = TCP_PB_SIP; break;
    case am_siph: type = TCP_PB_SIPH; break;
    case am_sip_bin: type = TCP_PB_SIP_BIN; break;
    case am_siph_bin: type = TCP_PB_SIPH_BIN; break;
    ...
    pca.string_as_bin = (type == TCP_PB_HTTP_BIN || type == TCP_PB_HTTPH_BIN || type == TCP_PB_SIPH_BIN || type == TCP_PB_SIP_BIN );
